...
// SCS
const Data = React.lazy(() => import('./views/scs/data/data'));
const Maintain = React.lazy(() => import('./views/scs/maintain/Maintain'));
const Setup = React.lazy(() => import('./views/scs/setup/Setup'));
const Setting = React.lazy(() => import('./views/scs/setting/setting'));
...
const routes = [
  ...
  //SCS Data
  { path: '/scs/data', name: 'Data', element: Data, exact: true },
  { path: '/scs/maintain', name: 'Maintain', element: Maintain, exact: true },
  { path: '/scs/setup', name: 'Setup', element: Setup, exact: true },
  { path: '/scs/setting', name: 'Setting', element: Setting, exact: true },
